...
void loop() {
 ...
 Serial.print("Water Level: "); wtrLevel = getWtrLevel(wtrLevel);
  Serial.println();
  delay(1000);
  Serial.print(tempVal = getTemp(tempVal));Serial.print(" Celcius");  
  Serial.println();

  delay(1000); 
  Serial.print("Soil Moisture Level: ");smsAnalog = getSoil (smsAnalog);
